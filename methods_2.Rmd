...
if(raw_dem_eval){
  ...
  elev_raw <- get_elev_raster(cume_fire_tif,z=8)
  #Save raw file
...
plot(cume,col= hcl.colors(30,'viridis'),frame=F,axes=F)
plot(elev,col= hcl.colors(20,'Grays'), add = T,frame=F,axes=F, legend = F)
...
elev_study <- raster('data/out/elev_study.tif')
  ...
  plot(elev_study,col= hcl.colors(20,'Grays'),frame = F)
...
plot(breached_tif,col= hcl.colors(20,'Grays'),frame=F,axes=F, legend = F)
...
plot(breached_tif,col= hcl.colors(20,'Grays'),frame=F,axes=F, legend = F)
plot(larimer_l,col= hcl.colors(30,'Spectral'), frame = F, add = T)
...
plot(breached_tif,col= hcl.colors(20,'Grays'),frame=F,axes=F, legend = F)
plot(larimer_2,col= hcl.colors(30,'Spectral'), frame = F, add = T)

breached_crop <- crop(breached_tif,larimer)

plot(breached_crop,col= hcl.colors(20,'Grays'),frame=F,axes=F, legend = F)
plot(larimer_l,col= hcl.colors(30,'Spectral'), frame = F, add = T)
